 ...
 *       &lt;sequence&gt;
 *         &lt;element name="productos" type="{http://www.ef.dsw.soap/ws/objects}productows" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetProductosResponse {
    ...
    protected List<Productows> productos;
    ...
    public List<Productows> getProductos() {
        if (productos == null) {
            productos = new ArrayList<Productows>();
        }
