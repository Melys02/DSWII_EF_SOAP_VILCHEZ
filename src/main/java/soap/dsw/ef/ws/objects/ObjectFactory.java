 ...
 * generated in the soap.dsw.ef.ws.objects package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: soap.dsw.ef.ws.objects
     * 
     */
